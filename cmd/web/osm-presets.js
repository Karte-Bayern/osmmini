...
(function(root){
  ...
  const fields=Object.assign(Object.create(null),{
    ...
    ref:{key:'ref',label:'Kennung',type:'text',placeholder:'z. B. Haltestellennummer'},
  ...
  const presets=Object.assign(Object.create(null),{
    ...
    defibrillator:{label:'Defibrillator',icon:'❤️',group:'Notfall & Zugang',tags:{emergency:'defibrillator'},fields:['defibrillator:location','indoor','opening_hours','phone']},
